...
public class JavaClassBrowser extends MDS_Frame {



	public JavaClassBrowser() {
		super("Class Connection Walker",true, true, true, true, ImageManipulator.getImageIcon(ImageManipulator.MDS_ICONS_PATH + "32-app-ksplash.png"));  
	...
	public class ClassBrowser extends JSplitPane implements ListSelectionListener, TreeSelectionListener, ActionListener {

	    JFrame frame;
		MDS_Button apiButton;
		...
		public void swap(Method a[], int i, int j) {
			Method temp;
			temp = a[i];
			a[i] = a[j];
			a[j] = temp;
	    ...
	    conslist.setCellRenderer(new ModifiedCellRenderer());
			...
			// $$$  ****  apiButton = new MDS_Button("Open API doc");
